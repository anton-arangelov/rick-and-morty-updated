  ...
  return (
    <Fragment>
      <Switch>
        ...
        <Route path="/home/:selectedPage">
          <AllEpisodes />
        </Route>
        <Route path="/detail/:id/:selectedPage" exact>
          <DetailedEpisode />
        </Route>
        <Route path={`/origin/:id/:selectedPage`} exact>
          <Origin />
        </Route>
        <Route path={`/location/:id/:selectedPage`} exact>
          <Location />
        </Route>
        <Route path="/search/:searchValue/:selectedPage" exact>
          <SearchCharacters />
        </Route>
        <Route path="*">
